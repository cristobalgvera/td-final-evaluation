/* 
   ...
   Script de preparacion del modelo de datos ClassicModels

*/


-- Esta instruccion deshabilita la sustitucion de variables en las sentencias SQL
-- debe ser ejecutada previo al inicio de la creacion del esquema
set define off;
...
CREATE TABLE products (
  ...
  productDescription varchar2(2000) NOT NULL,
